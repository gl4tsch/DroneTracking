...
int main()
{
	...
	while (true)
	{
		...
		frameCounter++;
		if (frameCounter == cap.get(CV_CAP_PROP_FRAME_COUNT)) //if end of video file reached
		{
			frameCounter = 1;
		...
		//if (waitKey(0) == 32) //wait for 'space' key press forever. If 'space' key is pressed, continue loop
		//{
